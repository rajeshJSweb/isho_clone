            ...
            <div className='md:mx-[76px] md:px-[30px]'>
                ...
                <div className='w-full'>
                    <div className='w-full'>
                            ...
                            >
                                <SwiperSlide >
                                   <div onClick={handlePersonalWorkspace} className='bg-blue-300 p-5 md:p-10 cursor-pointer'>
                                    <img className='object-contain w-full' src="https://i.ibb.co/7xhpfPr/Al-HLXm-CRFg-HUFe-UVSDL0-Nypp-MSczfp4f3-MC6x0-JP.jpg" alt="" />
                                        <div className='mt-[50px] flex justify-between items-center'>
                                            <h1 className='text-[18px] text-white font-semibold'>Personal Workspace</h1>
                                            <MdNavigateNext className='text-white w-[40px] h-[40px] bg-slate-300 rounded-full text-3xl font-semibold'/>
                                        </div>
                                   </div>
                                </SwiperSlide>
                                <SwiperSlide >
                                    <div onClick={handleUnwindingZone} className='bg-yellow-500 p-5 md:p-10 h-full'>
                                        <img className='w-full' src="https://i.ibb.co/BgTf2sd/r-Fb8-V3-V9-An-Fo3i-Hw-J6pi-Fydp1-P8jr-Qb97-Epquz2a.jpg" alt="" />
                                        <div className='mt-[50px] pb-[2px] flex justify-between items-center cursor-pointer'>
                                            <h1 className='text-[18px] text-white font-semibold'>Unwinding Zone</h1>
                                            <MdNavigateNext className='text-white w-[40px] h-[40px] bg-slate-300 rounded-full text-3xl font-semibold'/>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide >
                                    <div className='bg-pink-500 p-5 md:p-10'>
                                        <img className='w-full' src="https://i.ibb.co/kH4Xrqr/Byg-ZNCk-HOi-Kq4pqm-Ri-I7nuoi-C7h3fm-Uao8-W1-Lfe4.jpg" alt="" />
                                        <div className='mt-[50px] flex justify-between items-center cursor-pointer'>
                                            <h1 className='text-[18px] text-white font-semibold'>Lounge Area</h1>
                                            <MdNavigateNext className='text-white w-[40px] h-[40px] bg-slate-300 rounded-full text-3xl font-semibold'/>
                                        </div>
                                    </div>
                                </SwiperSlide>
