  ...
  return (
    <div className="relative mt-[100px] z-0">
      <div className="px-[20px] md:mx-[76px] md:px-[30px] ">
        <h1 className="text-center text-[25px] md:text-[36px] font-semibold mb-[45px]">
          New Arrivals
        </h1>
        <div className="my-10">
          {isLoading && (
          ...
          >
            {products &&
              products.map((product) => (
                <SwiperSlide key={product.id} product={product}>
        ...
        <div className="mb-10 flex justify-center items-center">
          <Link
            to="/all_products"
            className="bg-blue-400 py-2 md:py-5 px-5 md:px-10 md:font-semibold text-white rounded-full"
          >
            View All Items
          </Link>
        </div>
